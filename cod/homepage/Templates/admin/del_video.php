                            ...
                            <div class="col-lg-12 center">
                                ...
                                <form role="form" method="post">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block"><?php echo $video->getId_video(); ?></p>
                                    </div>
                                    <div class="form-group">
                                        <label>ID do video no Youtube</label>                                        
                                        <p class="help-block"><?php echo $video->getVideo(); ?></p>
                                    </div>
                                    <input type="submit" class="btn btn-danger" value='Deletar' name='deletar' >                                    
                                    <a href="<?php echo $this->base_url ?>adminVideo/" class="btn btn-default">Cancelar</a>
                                </form>
